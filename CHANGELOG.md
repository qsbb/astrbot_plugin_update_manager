...
### 新增
- 系列推荐新增凝心溯溪-情 `astrbot_plugin_relationship`，支持检查版本、安装、更新与启用停用。
- 版本检查默认并发上限调整为 6，以覆盖当前六个可信系列插件。

### 修复
- 修复 Plugin Page 中「前往仓库更新」链接在 iframe 或弹窗策略下点击无跳转的问题，增加显式外部链接打开与顶层跳转兜底。
